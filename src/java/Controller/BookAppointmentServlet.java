...
public class BookAppointmentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      if ( acc!=null){
      request.setAttribute("patient", acc.getUser());    
      }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if (acc!=null){
        ...
        Date dateapp        = Date.valueOf(request.getParameter("dateapp"));
        ...
        schedule.setID_Patient(patientID);
        schedule.setID_Staff(staffID);
        schedule.setServiceld(serviceID);
        schedule.setDate_apm(dateapp);
        schedule.setStart_Time(startTime);
        schedule.setEnd_Time(endTime);
        schedule.setConfirm("No Reply");
       DAOFactory.getScheduleDAO().insertSchedule(schedule);
